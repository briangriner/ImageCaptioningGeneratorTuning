...
''' Andrew snip to modify data generator:
...
for i in range(epochs):
    ...
    # save model
    if( history.history["loss"] < lowLoss ):
...
# evaluate the skill of the model - EVALUATE ONLY 5 PHOTOS
...
# load dev set
filename = '/Users/briangriner/Py-image_captioning/chapter_26-Flikr8k/Flickr8k_text/Flickr_8k.devImages.txt'
...
# define experiment - BASELINE GENERATE - REPEATS=1
